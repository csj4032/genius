...
public class UserTemplate extends AbstractKakaoOperations implements UserOperation {
	...
	public KakaoProfile getUserProfile(String[] profiles) {
		requireAuthorization();
		MultiValueMap<String, Object> param = new LinkedMultiValueMap<>();
		param.set("property_keys", String.join(",", profiles));
		return restTemplate.postForObject(buildApiUri("/v1/user/me"), param, KakaoProfile.class);
	}
