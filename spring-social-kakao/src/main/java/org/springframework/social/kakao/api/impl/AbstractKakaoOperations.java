...
public class AbstractKakaoOperations {
	...
	private final static MultiValueMap<String, String> EMPTY_PARAMETER = new LinkedMultiValueMap<>();
	...
	protected URI buildApiUri(String host , String path) {
		return buildApiUri(host, path, EMPTY_PARAMETER);
	}
	...
	protected URI buildApiUri(String host, String path, MultiValueMap<String, String> parameters) {
