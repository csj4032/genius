...
import com.genius.backend.interfaces.GeniusController;
...
public class AlimyControllerTest {
	...
	@Test
	public void alimy() throws Exception {
		this.mockMvc.perform(get("/alimy/1")
	...
	public void alimySaveTest() throws Exception {
		this.mockMvc.perform(post("/alimy/save")
				.with(SecurityMockMvcRequestPostProcessors.authentication(authentication))
				.param("alimyId", "")
				.param("status", "1")
	...
	public void alimyUpdateTest() throws Exception {
		this.mockMvc.perform(post("/alimy/update")
				.with(SecurityMockMvcRequestPostProcessors.authentication(authentication))
				.header("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2743.116 Safari/537.36")
				.header("X-FORWARDED-FOR", "127.0.0.1")
				.param("alimyId", "1")
	...
	public void alimyDeleteTest() throws Exception {
		this.mockMvc.perform(delete("/alimy/delete")
				.with(SecurityMockMvcRequestPostProcessors.authentication(authentication))
				.header("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2743.116 Safari/537.36")
				.header("X-FORWARDED-FOR", "127.0.0.1")
				.param("alimyId", "1")
	...
	public void alimyStatusTest() throws Exception {
		this.mockMvc.perform(put("/alimy/status")
				.with(SecurityMockMvcRequestPostProcessors.authentication(authentication))
				.param("alimyId", "1")
				.header("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2743.116 Safari/537.36")
				.header("X-FORWARDED-FOR", "127.0.0.1")
