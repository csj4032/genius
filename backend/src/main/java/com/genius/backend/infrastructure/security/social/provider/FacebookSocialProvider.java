...
public class FacebookSocialProvider implements SocialProvider {
	...
	public void sendMessage(String text) {
		...
		var pageAccessToken = facebookProperties.getPageAccessToken();
		...
		var mUrl = "https://graph.facebook.com/v2.6/me/messages?access_token=" + pageAccessToken;
